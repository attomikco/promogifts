    ...
    <>
      ...
      {featuredProducts.length > 0 && (
        <section className="py-16">
          <div className="mx-auto max-w-7xl px-4 sm:px-6">
            ...
            <p className="mt-2 text-[var(--mid)]">Lo más solicitado por nuestros clientes</p>
      ...
      {recentProducts.length > 0 && (
        <section className="bg-[var(--pale)] py-16">
          <div className="mx-auto max-w-7xl px-4 sm:px-6">
            <h2 className="text-3xl font-bold text-[var(--black)]">Productos Recientes</h2>
            <p className="mt-2 text-[var(--mid)]">Los últimos artículos agregados a nuestro catálogo</p>
            <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
      ...
      <section className="bg-[var(--brand)] py-16">
        <div className="mx-auto max-w-3xl px-4 text-center sm:px-6">
          ...
          <p className="mt-4 text-lg text-white/80">
            Solicita tu cotización gratuita y recibe una propuesta personalizada en menos de 24 horas.
          </p>
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            <a href="mailto:hola@promogifts.com.mx" className="rounded-full bg-white px-6 py-3 text-sm font-semibold text-[var(--brand)] transition hover:bg-white/90">
              Enviar correo
            </a>
            <a href="https://wa.me/521XXXXXXXXXX?text=Hola%2C%20quiero%20una%20cotizaci%C3%B3n" target="_blank" rel="noopener noreferrer" className="rounded-full border border-white/30 px-6 py-3 text-sm font-semibold text-white transition hover:bg-white/10">
              WhatsApp
            </a>
          </div>
        </div>
      ...
      {/* WhatsApp float */}
      <a href="https://wa.me/521XXXXXXXXXX?text=Hola%2C%20quiero%20una%20cotizaci%C3%B3n" target="_blank" rel="noopener noreferrer" className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full shadow-lg transition hover:scale-110" style={{ backgroundColor: '#25D366' }} aria-label="Contactar por WhatsApp">
